...
public class Signaler
{
    ...
    private final ByteBuffer rdummy;

    // Selector.selectNow at every sending message doesn't show enough
    // performance
    ...
    public void send()
    {
        ...
        int nbytes = 0;
        final ByteBuffer dummy = ByteBuffer.allocate(1);
        dummy.limit(1);
    ...
    public boolean wait_event(final long timeout_)
    {
        ...
        try {
            ...
            if (timeout_ == 0) {
                ...
                // On the other hand, we can save lots of system call and
