...
public class XSub extends SocketBase
{
    ...
    public static class XSubSession extends SessionBase
    {
        ...
        public XSubSession(final IOThread io_thread_, final boolean connect_,
    ...
    static {
        send_subscription = new Trie.ITrieHandler()
        {
            ...
            @Override
            public void added(final byte[] data_, final int size,
                              final Object arg_)
            {

                final Pipe pipe = (Pipe) arg_;

                // Create the subsctription message.
                final Msg msg = new Msg(size + 1);
    ...
    public XSub(final Ctx parent_, final int tid_, final int sid_)
    {
    ...
    private boolean match(final Msg msg_)
    {
