...
public class YPipe<T>
{
    ...
    public final void write(final T value_, final boolean incomplete_)
    {
    ...
    public final T probe()
    {
        ...
        final boolean rc = check_read();
        assert (rc);

        final T value = queue.front();
        return value;
    }
