...
public class IOObject implements IPollEvents
{
    ...
    public IOObject(final IOThread io_thread_)
    {
        if (io_thread_ != null) {
            plug(io_thread_);
        }
    ...
    public void plug(final IOThread io_thread_)
    {
    ...
    public final void set_pollconnect(final SelectableChannel handle)
    {
        poller.set_pollconnect(handle);
    }

    public final void set_pollaccept(final SelectableChannel handle)
    {
        poller.set_pollaccept(handle);
    }

    public final void reset_pollin(final SelectableChannel handle)
    {
        poller.reset_pollin(handle);
    }

    public final void reset_pollout(final SelectableChannel handle)
    {
    ...
    @Override
    public final void timer_event(final int id_)
    {
        handler.timer_event(id_);
    }

    public final void add_timer(final long timeout_, final int id_)
    {
        poller.add_timer(timeout_, this, id_);
    }

    public final void set_handler(final IPollEvents handler)
    {
        this.handler = handler;
    }

    public void cancel_timer(final int id_)
    {
