...
public class Dist
{
    ...
    public void match(final Pipe pipe_)
    {

        final int idx = pipes.indexOf(pipe_);
    ...
    public boolean send_to_all(final Msg msg_)
    {
        matching = active;
    ...
    public boolean send_to_matching(final Msg msg_)
    {
    ...
    private void distribute(final Msg msg_)
    {
    ...
    private boolean write(final Pipe pipe_, final Msg msg_)
    {
        if (!pipe_.write(msg_)) {
            Utils.swap(pipes, pipes.indexOf(pipe_), matching - 1);
            matching--;
