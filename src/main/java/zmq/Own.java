...
abstract public class Own extends ZObject
{
    ...
    public Own(final Ctx parent_, final int tid_)
    {
        super(parent_, tid_);
        terminating = false;
    ...
    public Own(final IOThread io_thread_, final Options options_)
    {
        super(io_thread_);
        options = options_;
        terminating = false;
    ...
    private void set_owner(final Own owner_)
    {
        assert (owner == null);
        owner = owner_;
    }
    ...
    protected void launch_child(final Own object_)
    {
    ...
    protected void term_child(final Own object_)
    {
        process_term_req(object_);
    }

    @Override
    protected void process_term_req(final Own object_)
    {
        ...
        // value of linger is used, rather than the value stored by the
        // children.
        send_term(object_, options.linger);
    }

    @Override
    protected void process_own(final Own object_)
    {
    ...
    public void register_term_acks(final int count_)
    {
        term_acks += count_;
    }
