...
public class ZMQ
{
    ...
    /**
     * EVENT_ALL: all events known. The EVENT_ALL constant can be used to set up
     * a monitor for all known events.
     */
    ...
    public static class Context implements Closeable
    {
         ...
         */
        public boolean setIOThreads(final int ioThreads)
        {
         ...
         */
        public boolean setMaxSockets(final int maxSockets)
        {
    ...
    public static class Socket implements Closeable
    {
        ...
        protected Socket(final SocketBase base_)
        {
            ctx = null;
            base = base_;
        }
        ...
        private void setsockopt(final int option, final Object value)
        {
            try {
                base.setsockopt(option, value);
            }
            catch (final CtxTerminatedException e) {
            }
        }
         ...
         */
        public final void setLinger(final long value)
        {
        ...
        /**
         */
        public final void setReconnectIVL(final long value)
        {
        ...
        /**
         */
        public final void setBacklog(final long value)
        {
        ...
        /**
         */
        public final void setReconnectIVLMax(final long value)
        {
        ...
        /**
         */
        public final void setMaxMsgSize(final long value)
        {
        ...
        /**
         */
        public final void setSndHWM(final long value)
        {
        ...
        /**
         */
        public final void setRcvHWM(final long value)
        {
         ...
         * that the specified 'socket' is communicating with. If this limit has
         * been reached the socket shall enter an exceptional state and
         * depending on the socket type, 0MQ shall take appropriate action such
         * as blocking or dropping sent messages. Refer to the individual socket
         * descriptions in the man page of zmq_socket[3] for details on the
         * exact action taken for each socket type.
         * @param hwm
         *            the number of messages to queue.
         */
        public final void setHWM(final long hwm)
        {
            setSndHWM(hwm);
            setRcvHWM(hwm);
        }
         ...
         */
        @Deprecated
        public final void setSwap(final long value)
        {
         ...
         * exclusively by I/O threads 1 and 2. See also in the man page of
         * zmq_init[3] for details on allocating the number of I/O threads for a
         * specific _context_.
         * @param value
         *            the io_thread affinity.
         */
        public final void setAffinity(final long value)
        {
         ...
         * application. If the socket has no identity, each run of an
         * application is completely separate from other runs. However, with
         * identity set the socket shall re-use any existing 0MQ infrastructure
         * configured by the previous run(s). Thus the application may receive
         * messages that were sent in the meantime, _message queue_ limits shall
         * be shared with previous run(s) and so on. Identity should be at least
         * one byte and at most 255 bytes long. Identities starting with binary
         * zero are reserved for use by 0MQ infrastructure.
         * @param identity
         */
        public final void setIdentity(final byte[] identity)
        {
         ...
         * @param value
         *            maximum send or receive data rate for multicast, default
         *            100
         */
        public final void setRate(final long value)
        {
            throw new UnsupportedOperationException();
        }
         ...
         * occur. CAUTION: Excersize care when setting large recovery intervals
         * as the data needed for recovery will be held in memory. For example,
         * a 1 minute recovery interval at a data rate of 1Gbps requires a 7GB
         * in-memory buffer. {Purpose of this Method}
         * @param value
         *            recovery interval for multicast in milliseconds, default
         *            10000
         */
        public final void setRecoveryInterval(final long value)
        {
            throw new UnsupportedOperationException();
        }
         ...
         */
        @Deprecated
        public final void setMulticastLoop(final boolean mcast_loop)
        {
            throw new UnsupportedOperationException();
        }
         ...
         */
        public final void setMulticastHops(final long value)
        {
            throw new UnsupportedOperationException();
        }
         ...
         * 0, recv will return immediately, with null if there is no message to
         * receive. If the value is -1, it will block until a message is
         * available. For all other values, it will wait for a message for that
         * amount of time before returning with a null and an EAGAIN error.
         * @param value
         *            Timeout for receive operation in milliseconds. Default -1
         *            (infinite)
         */
        public final void setReceiveTimeOut(final int value)
        {
        ...
        {
            return base.getsockopt(zmq.ZMQ.ZMQ_SNDTIMEO);
        }

        /**
         * Sets the timeout for send operation on the socket. If the value is 0,
         * send will return immediately, with a false if the message cannot be
         * sent. If the value is -1, it will block until the message is sent.
         * For all other values, it will try to send the message for that amount
         * of time before returning with false and an EAGAIN error.
         * @param value
         *            Timeout for send operation in milliseconds. Default -1
         *            (infinite)
         */
        public final void setSendTimeOut(final int value)
        {
         ...
         * socket option.
         * @param value
         *            underlying kernel transmit buffer size for the 'socket' in
         *            bytes A value of zero means leave the OS default
         *            unchanged.
         */
        public final void setSendBufferSize(final long value)
        {
         ...
         * buffer size for the 'socket' to the specified size in bytes. For
         * details refer to your operating system documentation for the
         * 'SO_RCVBUF' socket option.
         * @param value
         *            Underlying kernel receive buffer size for the 'socket' in
         *            bytes. A value of zero means leave the OS default
         *            unchanged.
         */
        public final void setReceiveBufferSize(final long value)
        {
         ...
         * establish an initial message filter. An empty 'option_value' of
         * length zero shall subscribe to all incoming messages. A non-empty
         * 'option_value' shall subscribe to all messages beginning with the
         * specified prefix. Mutiple filters may be attached to a single
         * 'ZMQ_SUB' socket, in which case a message shall be accepted if it
         * matches at least one filter.
         * @param topic
         */
        public final void subscribe(final byte[] topic)
        {
         ...
         * @param topic
         */
        public final void unsubscribe(final byte[] topic)
        {
         ...
         * @param cls
         */
        public final void setEncoder(final Class<? extends EncoderBase> cls)
        {
         ...
         * @param cls
         */
        public final void setDecoder(final Class<? extends DecoderBase> cls)
        {
         ...
         * encountered.
         * @param mandatory
         *            A value of false is the default and discards the message
         *            silently when it cannot be routed. A value of true returns
         *            an EHOSTUNREACH error code if the message cannot be
         *            routed.
         */
        public final void setRouterMandatory(final boolean mandatory)
        {
         ...
         *            subscription messages to upstream. A value of true passes
         *            all subscription messages upstream.
         */
        public final void setXpubVerbose(final boolean verbose)
        {
         ...
         * @param v4only
         *            A value of true will use IPv4 sockets, while the value of
         *            false will use IPv6 sockets
         */
        ...
        /**
         * Accept messages only when connections are made If set to true, will
         * delay the attachment of a pipe on connect until the underlying
         * connection has completed. This will cause the socket to block if
         * there are no other connections, but will prevent queues from filling
         ...
         */
        public final int bind(final String addr)
        {
         ...
         */
        private final int bind(String addr, final int min, final int max)
        {
            if (addr.endsWith(":*")) {
                int port = min;
                final String prefix = addr.substring(0,
                                                     addr.lastIndexOf(':') + 1);
                while (port <= max) {
                    addr = prefix + port;
         ...
         *            the endpoint to bind to.
         */
        public int bindToRandomPort(final String addr)
        {
            return bind(addr + ":*", DYNFROM, DYNTO);
        }
         ...
         *            The maximum port in the range of ports to try.
         */
        public int bindToRandomPort(final String addr, final int min,
                                    final int max)
        {
         ...
         */
        public final void connect(final String addr)
        {
            base.connect(addr);
            mayRaise();
        }
         ...
         */
        public final boolean disconnect(final String addr)
        {
         ...
         * @return true if successful.
         */
        public final boolean unbind(final String addr)
        {
            return base.term_endpoint(addr);
        }

        public final boolean send(final String data)
        {
            return send(data.getBytes(CHARSET), 0);
        }

        public final boolean sendMore(final String data)
        {
            return send(data.getBytes(CHARSET), zmq.ZMQ.ZMQ_SNDMORE);
        }

        public final boolean send(final String data, final int flags)
        {
        ...
        public final boolean sendMore(final byte[] data)
        {
            return send(data, zmq.ZMQ.ZMQ_SNDMORE);
        }

        public final boolean send(final byte[] data, final int flags)
        {
            final zmq.Msg msg = new zmq.Msg(data);
         ...
         */
        public final int sendByteBuffer(final ByteBuffer data, final int flags)
        {
            final zmq.Msg msg = new zmq.Msg(data);
            if (base.send(msg, flags)) {
                return msg.size();
         ...
         * @return the message received, as an array of bytes; null on error.
         */
        public final byte[] recv(final int flags)
        {
            final zmq.Msg msg = base.recv(flags);
         ...
         */
        public final int recv(final byte[] buffer, final int offset,
                              final int len, final int flags)
        {
            final zmq.Msg msg = base.recv(flags);

            if (msg != null) {
                final int size = msg.getBytes(0, buffer, offset, len);
                return size;
            }
         ...
         * @return the number of bytes read, -1 on error
         */
        public final int recvByteBuffer(final ByteBuffer buffer, final int flags)
        {
            final zmq.Msg msg = base.recv(flags);
         ...
         * @return the message received, as a String object; null on no message.
         */
        public final String recvStr(final int flags)
        {
            final byte[] msg = recv(flags);
         ...
         * @param addr
         *            the endpoint to receive events from. (must be inproc
         *            transport)
         * @param events
         ...
         * @throws ZMQException
         */
        public boolean monitor(final String addr, final int events)
        {
    ...
    public static class Poller
    {
        ...
        /**
         * Register a Socket for polling on the specified events. Automatically
         * grow the internal representation if needed.
         * @param socket
         *            the Socket we are registering.
         * @param events
         ...
         */
        public int register(final SelectableChannel channel, final int events)
        {
        ...
        /**
         * Register a Channel for polling on the specified events. Automatically
         * grow the internal representation if needed.
         * @param item
         *            the PollItem we are registering.
         * @return the index identifying this Channel in the poll set.
         */
        public int register(final PollItem item)
        {
            return insert(item);
        }

        private int insert(final PollItem item)
        {
            final int pos = next++;
            if (pos == items.length) {
                final PollItem[] nitems = new PollItem[items.length
                                                       + SIZE_INCREMENT];
         ...
         */
        public PollItem getItem(final int index)
        {
         ...
         * @return how many objects where signaled by poll ()
         */
        public int poll(final long tout)
        {

            final zmq.PollItem[] pollItems = new zmq.PollItem[next];
        ...
        /**
         * Check whether the specified element in the poll set was signaled for
         * input.
         * @param index
    ...
    public static class PollItem
    {
        ...
        public PollItem(final Socket socket, final int ops)
        {
            this.socket = socket;
            base = new zmq.PollItem(socket.base, ops);
        }

        public PollItem(final SelectableChannel channel, final int ops)
        {
        ...
        public boolean equals(final Object obj)
        {
            ...
            final PollItem target = (PollItem) obj;
            if (socket != null && socket == target.socket) {
                return true;
            }

            if (getRawSocket() != null
                && getRawSocket() == target.getRawSocket()) {
                return true;
            }
    ...
    public enum Error
    {
        ...
        ENOTSUP(ZError.ENOTSUP), EPROTONOSUPPORT(ZError.EPROTONOSUPPORT), ENOBUFS(
                                                                                  ZError.ENOBUFS), ENETDOWN(
                                                                                                            ZError.ENETDOWN), EADDRINUSE(
                                                                                                                                         ZError.EADDRINUSE), EADDRNOTAVAIL(
                                                                                                                                                                           ZError.EADDRNOTAVAIL), ECONNREFUSED(
                                                                                                                                                                                                               ZError.ECONNREFUSED), EINPROGRESS(
                                                                                                                                                                                                                                                 ZError.EINPROGRESS), EMTHREAD(
                                                                                                                                                                                                                                                                               ZError.EMTHREAD), EFSM(
                                                                                                                                                                                                                                                                                                      ZError.EFSM), ENOCOMPATPROTO(
                                                                                                                                                                                                                                                                                                                                   ZError.ENOCOMPATPROTO), ETERM(
                                                                                                                                                                                                                                                                                                                                                                 ZError.ETERM);
    ...
    @Deprecated
    public static boolean device(final int type_, final Socket frontend,
     ...
     * frontend and backend. Before calling ZMQ.proxy() you must set any socket
     * options, and connect or bind both frontend and backend sockets. The two
     * conventional proxy models are: ZMQ.proxy() runs in the current thread and
     * returns only if/when the current context is closed.
     * @param frontend
     *            ZMQ.Socket
     * @param backend
     *            ZMQ.Socket
     ...
     */
    public static boolean proxy(final Socket frontend, final Socket backend,
                                final Socket capture)
    {
        return zmq.ZMQ.zmq_proxy(frontend.base, backend.base,
                                 capture != null ? capture.base : null);
    }

    public static int poll(final PollItem[] items, final long timeout)
    {
        return poll(items, items.length, timeout);
    }

    public static int poll(final PollItem[] items, final int count,
                           final long timeout)
    {

        final zmq.PollItem[] items_ = new zmq.PollItem[count];
    ...
    {
        return "" + zmq.ZMQ.ZMQ_VERSION_MAJOR + "." + zmq.ZMQ.ZMQ_VERSION_MINOR
               + "." + zmq.ZMQ.ZMQ_VERSION_PATCH;
    }
    ...
    public static class Event
    {
        ...
        public Event(final int event, final Object value, final String address)
        {
            this.event = event;
            this.value = value;
         ...
         * @throws ZMQException
         */
        public static Event recv(final Socket socket, final int flags)
        {
            final zmq.ZMQ.Event e = zmq.ZMQ.Event.read(socket.base, flags);
         ...
         * @throws ZMQException
         */
        public static Event recv(final Socket socket)
        {
