...
public class TestZLoop
{
    ...
    public void testZLoop()
    {
        ...
        final ZLoop.IZLoopHandler timerEvent = new ZLoop.IZLoopHandler()
        {
        ...
        final ZLoop.IZLoopHandler socketEvent = new ZLoop.IZLoopHandler()
        {
        ...
        final PollItem pollInput = new PollItem(output, Poller.POLLIN);
    ...
    public void testZLoopAddTimerFromTimer()
    {
        ...
        final ZLoop.IZLoopHandler timerEvent = new ZLoop.IZLoopHandler()
        {
                              ...
                              final Object arg)
            {
                ...
                final ZLoop.IZLoopHandler timerEvent2 = new ZLoop.IZLoopHandler()
                {
                    @Override
                    public int handle(final ZLoop loop, final PollItem item,
                                      final Object arg)
    ...
    public void testZLoopEndReactorFromTimer()
    {
        ...
        final ZLoop.IZLoopHandler socketEvent = new ZLoop.IZLoopHandler()
        {
                              ...
                              final Object arg)
            {
                ...
                final ZLoop.IZLoopHandler shutdownEvent = new ZLoop.IZLoopHandler()
                {
                    @Override
                    public int handle(final ZLoop loop, final PollItem item,
                                      final Object arg)
