...
public class TestInvalidRep
{
    ...
    public void testInvalidRep()
    {
        ...
        final SocketBase router_socket = ZMQ.zmq_socket(ctx, ZMQ.ZMQ_ROUTER);
        assertThat(router_socket, notNullValue());

        final SocketBase req_socket = ZMQ.zmq_socket(ctx, ZMQ.ZMQ_REQ);
