...
public class kvmsg
{
    ...
    private void encodeProps()
    {
        ...
        for (final Entry<Object, Object> o : props.entrySet()) {
            final String prop = o.getKey().toString() + "="
                                + o.getValue().toString() + "\n";
    ...
    public static kvmsg recv(final Socket socket)
    {
        ...
        for (frameNbr = 0; frameNbr < KVMSG_FRAMES; frameNbr++) {
            ...
            final boolean rcvmore = (frameNbr < KVMSG_FRAMES - 1) ? true
                                                                 : false;
    ...
    public kvmsg dup()
    {
        ...
        for (frameNbr = 0; frameNbr < KVMSG_FRAMES; frameNbr++) {
            if (present[frameNbr]) {
                ...
                System.arraycopy(frame[frameNbr], 0, kvmsg.frame[frameNbr], 0,
                                 frame[frameNbr].length);
    ...
    // value is 255 chars.
    public void setProp(final String name, final String fmt,
                        final Object... args)
    {
